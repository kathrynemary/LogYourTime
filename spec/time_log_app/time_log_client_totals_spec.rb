...
describe TimeLogClientTotals do
  ...
  before :each do
		...
		TimeLog.set_end_time("May 3 2016, 13:10")
	...
	it "should return this month's events for the client examplecompany" do
		TimeLogClientTotals.get_client_events("ExampleCompany", "spec/spec_data_files/example_time_log_client_totals_events.yml")
